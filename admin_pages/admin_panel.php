...
<html>
    <head>
        ...
        <title>NeoTones - AllTime Sales</title>
    ...
    <header>
        ...
        <div class="toolbar">
            ...
            <div><form action="" class="s_top" method="post"><input type='search' name="search" placeholder="Search" style="padding: 6px; border-radius: 0; border: none; margin-left: 5px; margin-right:5px;">
    ...
    <?php
        echo "<h1 align=left>Total Sales - All Time</h1>";
                    require_once"../config.php";
                    $revenue=0;

                    $total="SELECT COUNT(purchaseID) as num FROM `purchased_works` ";
                    ...
                    $elec="SELECT COUNT(purchaseID) as num FROM `purchased_works` WHERE `Genre`='electronic'; ";
                    ...
                    $afro="SELECT COUNT(purchaseID) as num FROM `purchased_works` WHERE `Genre`='afro'; ";
                    ...
                    $cty="SELECT COUNT(purchaseID) as num FROM `purchased_works` WHERE `Genre`='country'; ";
                    ...
                    $gos="SELECT COUNT(purchaseID) as num FROM `purchased_works` WHERE `Genre`='gospel'; ";
                    ...
                    $hip="SELECT COUNT(purchaseID) as num FROM `purchased_works` WHERE `Genre`='hip-hop'; ";
                    ...
                    $jazz="SELECT COUNT(purchaseID) as num FROM `purchased_works` WHERE `Genre`='jazz'; ";
                    ...
                    $pop="SELECT COUNT(purchaseID) as num FROM `purchased_works` WHERE `Genre`='pop'; ";
                    ...
                    $reg="SELECT COUNT(purchaseID) as num FROM `purchased_works` WHERE `Genre`='reggae'; ";
                    ...
                    $roc="SELECT COUNT(purchaseID) as num FROM `purchased_works` WHERE `Genre`='rock'; ";
                    ...
                    $sql = "SELECT purchaseID,`Artist Name`, COUNT(purchaseID) AS `value_occurrence` FROM `purchased_works` GROUP BY `Artist Name` ORDER BY `value_occurrence` DESC LIMIT 1;";
                    $query= $con ->query($sql) or die($con->error);
                    $row = $query->fetch_assoc();
                    echo"<h3>Top Selling Artist <br></h3>";
                    echo "<div id='art'>".$row['Artist Name']." : ".$row['value_occurrence']."</div>";
                    echo"<br>";
