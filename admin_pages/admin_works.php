    ...
    <p>Please fill this form to create an account.</p>
            <form action="db_write.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="rel" style="    padding: 6px;font-size: 17px;margin-bottom: 5px;margin-top: 5px;
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="confirm_password" style="    padding: 6px;font-size: 17px;margin-bottom: 5px;margin-top: 5px;
